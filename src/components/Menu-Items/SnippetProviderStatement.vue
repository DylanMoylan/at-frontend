<template>
    <q-card>
        <q-card-section class="primo text-white text-h6 q-pa-md row justify-between">
...
export default {
    ...
    computed: {
        snippet() {
            return utils.cleanHTML.cleanEntities(`<p><img src="/webmd/professional_assets/medscape/images/provider/medscape1.150x34.gif" alt="Medscape" /><br />
